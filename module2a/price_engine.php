...
<body>
    <div class="receipt">
        ...
        <?php
            ...
            $color = 'Purple'; // Any string, but test with 'Sunset Orange' or 'Ocean Blue'
            $isCustomized = false; // Options: true, false
            $customerFirstName = 'Sarah'; // <-- IMPORTANT: REPLACE WITH YOUR ACTUAL FIRST NAME
            ...
            if ($color === 'Sunset Orange') {
                ...
                $details .= "<li>Premium Color (Sunset Orange) Upcharge: <span>+$2.00</span></li>";
            }

            if ($color === 'Ocean Blue') {
                $finalPrice = $finalPrice + 2.00;
                $details .= "<li>Premium Color (Ocean Blue) Upcharge: <span>+$2.00</span></li>";
            }
            ...
            if ($isCustomized) {
                ...
                if ($size === 'XL') {
                    ...
                    $details .= "<li>Customization Size (XL) Upcharge: <span>+$3.00</span></li>";
                }
            }
